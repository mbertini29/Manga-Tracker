...
const HomePage = () => {
    ...
    return disabilita; // rendi disponibile la variabile che disabilita il listener a react e lui la chiama quando serve 
    }, [navigate]);
